...
"C:\Users\Administrator\AppData\Local\Microsoft\WindowsApps\python.exe" -m streamlit run 스내피즘.py --server.port 8503 --browser.gatherUsageStats false --server.headless true
pause
