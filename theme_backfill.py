...
def _months(since: str):
    ...
    ★이 전제가 한 번 깨졌다 — 매일 수집에 테마가 들어간 게 2026-08-12 라
      2026-08-01~11 은 백필도 건너뛰고 매일 수집도 안 해서 아무도 안 채웠다.
      지금은 sm_daily 가 **마지막 받은 날짜를 보고 밀린 만큼 창을 늘리므로**
      (`_catchup_start`) 이번 달을 빼도 구멍이 남지 않는다."""
